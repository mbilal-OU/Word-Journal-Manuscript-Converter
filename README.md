...
> **Current status: v0.3.0 public beta.** The project is designed to be conservative. It does not claim perfect conversion for every journal or every Word file.
